        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BillUserUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Bills", x => x.BillId);
                    table.ForeignKey(
                        name: "FK_Bills_Users_BillUserUserId",
                        column: x => x.BillUserUserId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProductUser", x => new { x.UsersUserId, x.productsProductId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bills_BillUserUserId",
                table: "Bills",
                column: "BillUserUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProductUser_productsProductId",
                table: "ProductUser",
